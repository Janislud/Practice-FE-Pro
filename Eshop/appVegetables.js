...
updateProducts(updatedVegetables); // Вызов функции для обновления продуктов на странице

const sortButton = document.getElementById('sortButton')
sortButton.addEventListener('click',() => {
    updatedVegetables.sort((a, b) => a.price - b.price);
    updateProducts(updatedVegetables)
});

const sortButton2 = document.getElementById('sortButton2')
sortButton2.addEventListener('click',() => {
    updatedVegetables.sort((a, b) => b.price - a.price);
    updateProducts(updatedVegetables)
});

// выводить общее количество товаров
const resultQuantity = document.getElementById('resultQuantity')
const totalSum = vegetables.reduce((accumulator, object) => {
...
const totalPrice = vegetables.reduce((accumulator, object) => {
...
const addButton = document.querySelector('.add'); // Выбираем кнопку "Add" из формы
  ...
  addButton.addEventListener('click', (event) => {
    ...
    updatedVegetables.push(newProduct);
    updateProducts(updatedVegetables);
